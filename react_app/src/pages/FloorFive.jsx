...
const FloorFivePage = () => {
    ...
    return (<div className='flex-1 overflow-auto relative z-10'>
        ...
        <main className='max-w-7x1 mx-auto py-6 px-4 lg:px-8'>
            ...
            >
                <StatCard name="Total Station" icon={Cpu} floor="floor5" upper_ratio='101' lower_ratio='0' color='#3498db' />
                    <StatCard name="Fine" icon={Smile} floor="floor5" upper_ratio='100' lower_ratio='50' color='#2ecc71' />
                    <StatCard name="Low" icon={Annoyed} floor="floor5" upper_ratio='49' lower_ratio='20' color='#f7dc6f' />
                    <StatCard name="Very Low" icon={TriangleAlert} floor="floor5" upper_ratio='19' lower_ratio='0' color='#e74c3c' />
            </motion.div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 lg:grid-flow-row gap-3 mb-5'>
                <RadialChart station = "Room 1" floor="floor5" room="room1" color="#0088FE"/>
                <RadialChart station = "Room 2" floor="floor5" room="room2" color="#00C49F"/>
                <RadialChart station = "Room 3" floor="floor5" room="room3" color="#FFBB28"/>
                <RadialChart station = "Room 4" floor="floor5" room="room4" color="#FF8042"/>
                <RadialChart station = "Room 5" floor="floor5" room="room5" color="#900C3F"/>
            </div>
            <h2 className='text-lg font-medium mb-4 text-gray-100'>
                Statistic
            </h2>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 lg:grid-flow-row gap-8'>
                <StatChart head="Monthly" floor="floor5"/>
                <TotalChart head="Paper used by Room" floor="floor5"/>
            </div>
        </main>
</div>
